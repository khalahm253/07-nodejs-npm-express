...
Article.prototype.insertRecord = function(callback) {
  $.post('/articles', {author: this.author, authorUrl: this.authorUrl, body: this.body, category: this.category, publishedOn: this.publishedOn, title: this.title})
    .then(data => {
      ...
      // The call back function above is set up for a new article to populate the browser. If call back is true, return the callback aka push new article to browser.Yes if it evaluates true (new article created by ueser) it calls the call back.
